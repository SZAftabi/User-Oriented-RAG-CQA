...
class RQEDataModule(pl.LightningDataModule):
    def __init__(self, data, val_data, tokenizer, script_args):
        super().__init__()
        self.data = data
    ...
    def setup(self, stage=None):
        ...
        self.val_data2 = RQEDataset(self.val_data, self.tokenizer, self.max_len, is_eval=True)
    ...
    def val_dataloader(self):
        return torch.utils.data.DataLoader(
            self.val_data2,
            sampler = torch.utils.data.SequentialSampler(self.val_data2,),
            batch_size= self.per_device_eval_batch_size,
            num_workers=4
        )